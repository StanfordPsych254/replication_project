...
All study participants were recruited on AMT. Individual sample sizes are given in Table \ref{tab:summary}. Each sample was recruited independently, using the same account but a different title. 
...
## Decision Points for Instructors

- how to customize for different levels of instructor
...
- student expertise
- group wiork
- Strength of evidence in original, e.g. BF > 3
