...
author-note:
    "*These authors contributed equally and are listed alphabetically. Thanks to the Stanford Department of Psychology and the Vice Provost for Graduate Education for funding to support the class. We are grateful to the authors of the original studies who provided materials and gave comments on a draft of this manuscript. RXDH, ENS, and MCF designed the project, supported data planning and data collection for all projects, analyzed the data, and wrote the paper. CA, JMA, RC, EH, MK, AL, SR, JR, SS, JS, and JT planned their individual projects, programmed their studies, collected their data, and analyzed their data."
...
We begin by describing the general method of the class, then discuss shared methods for the replications and the process of development for each project. In general, we report how we determined our sample size, all data exclusions, all manipulations, and all measures in the study.
