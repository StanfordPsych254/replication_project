...
We also describe our process for conducting replications as part of classroom pedagogy. Although mentorship in experimental methods is an important part of the standard advising relationship, the classroom context allows for elucidation of general principles of good research and discussion of how they can be modified to fit specific instances. And replication research in particular illustrates a number of important concepts -- experimental design, power analysis, reporting standards, and preregistration, among others -- in a way that more open-ended projects, which require new conceptual development, often do not [see @frank2012 for a more extended argument]. There are significant limitations on what can be done in a single term, within the constraints of a course budget and the instructors' expertise. Nevertheless, were this approach implemented more widely, we believe the dividends paid to the field as a whole would be considerable.
