...
(`r signif(coef(lm(d$rep_es~d$original_ES_d-1))[1], digits = 2)`\% of the original [`r signif(confint(lm(d$rep_es~d$original_ES_d-1))[1], digits = 2)` - `r signif(confint(lm(d$rep_es~d$original_ES_d-1))[2], digits = 2)`]). 
