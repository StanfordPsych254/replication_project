...
Learning Goal & \multicolumn{1}{p{2in}}{\raggedright Gain experience with research process} & \multicolumn{1}{p{2in}}{\raggedright Conduct collaborative research} & \multicolumn{1}{p{2in}}{\raggedright Learn best practices and tools} \\

Project Grouping & \multicolumn{1}{p{2in}}{\raggedright Full Class or Medium-sized groups (7-8 students)} & \multicolumn{1}{p{2in}}{\raggedright Small groups (2-4) or individual} & \multicolumn{1}{p{2in}}{\raggedright Individual} \\
...
Workflow tools & \multicolumn{1}{p{2in}}{\raggedright Use familiar or GUI tools or instructors implement studies} & \multicolumn{1}{p{2in}}{\raggedright Teach key open-source tool plus introduce others} & \multicolumn{1}{p{2in}}{\raggedright Teach full set of free open-source software} \\
...
\end{tabular}
\caption{\label{tab:classmodels} The potential models for incorporating replication studies in required coursework. *This can also be done with a systematic sampling strategy} 
