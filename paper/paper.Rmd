...
All study participants were recruited on AMT. Individual sample sizes are given in Table \ref{tab:summary}. Each sample was recruited independently, using the same account but a different title. All replications were approved by the Stanford University Institutional Review Board under protocol \#23274, "Reproducibility of psychological science and instruction."
...
All replication studies were coded in JavaScript, HTML, and CSS so as to be run in a standard web browser. All analyses were written using R, a free and open-source platform for statistical analysis. A schematic of our class workflow is shown in Figure 1. 
