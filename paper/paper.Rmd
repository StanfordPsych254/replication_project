...
tstatDF <- d %>%
  ...
  mutate(repBF = getBF(rep_t_stat, rep_t_df), 
         t_ratio = rep_t_df/original_t_df)

ggplot(tstatDF, aes(x = origBF, y = repBF)) +
  geom_point(alpha = .8, aes(size = t_ratio, 
  ...
  scale_x_log10(limits = c(10**-1.75, 10**11), 
                breaks = c(1/10, 1/3, 3, 10, 100),
                labels = c("1/10", "1/3", "3", "10")) +
  scale_y_log10(limits = c(10**-1.75, 10**11),
                breaks = c(1/10, 1/3, 3, 10, 100),
                labels = c("1/10", "1/3", "3", "10")) + 
  scale_size_continuous(name = "Ratio of replication to original t value") + 
  scale_color_solarized(name = "Subjective replication rating") + 
  theme_bw() +
  theme(legend.position="bottom")
  ...
  # geom_hline(aes(yintercept = 1/10), linetype = 2)+
  # geom_vline(aes(xintercept = 10), linetype = 2)+
  # geom_vline(aes(xintercept = 3), linetype = 2)+
  # geom_vline(aes(xintercept = 1/3), linetype = 2)+
  # geom_vline(aes(xintercept = 1/10), linetype = 2) +
```
