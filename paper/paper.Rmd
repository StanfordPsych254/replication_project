...
\multicolumn{2}{c}{Replicated} & \multicolumn{2}{c}{Original on Turk?} & \multicolumn{2}{c}{High fidelity?} & \multicolumn{3}{c}{Open Materials?} \\
  ...
  Total & 11 & 6 & 5 & 7 & 4 & 4 & 2 & 5 \\
   \hline
\end{tabular}
\caption{\label{tab:results} Counts of instructor team replication ratings, split by mediating variables. High fidelity denotes replications judged to be above the median rating of fidelity ( >`r median(d$fidelity)` out of 7).}
\end{table}
...
replication rating `r 100 * round(mean(d$replicated_TA[d$high_fidelity]), digits=2)`\% 
vs. 
