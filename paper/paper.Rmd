...
That said, we beleive there are many ways to adapt the project format based on the students and constraints of the class.  In Table \ref{tab:classmodels} below, we present mulitple ways in which replication projects may be included in classrooms.  Though we do not go into detail on the specifics of what each of these courses might entail, we hope this provides an overview of the possibilities inherent in including replication work as part of student learning.
...
\begin{tabular}{l|lll}
 ...
 & \underline{Model 1} & \underline{Model 2} & \underline{Model 3} \\
...
Greater/lesser proejct curation
...
Good faith replication based on the materials avaialble to an independent researcher.  This was an active choice. Only to receive materials or information not possible to resolve from the published article.

However, we acknowledge there are benefits of contacting all authors.  Even just to say "this is what we're doing"
