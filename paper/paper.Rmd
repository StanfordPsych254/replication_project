...
We end with a few recommendations for instructors designing such a course. First, plan as much as possible to make the project the centerpiece of the course, so that students begin the process as quickly as possible and do the maximal amount of skill learning in the context of their own goal-directed research. Second, rather than adopting the typical model of students turning in work at the end of the course and being assessed, consider a more collaborative model where the instructors provide iterative feedback on subcomponents of projects (e.g., sample analyses, parts of the experimental paradigm or materials). Such feedback can both save students time and frustration and provide a check on project quality before data are collected. Third and finally, try to share the excitement of discovery that is inherent in doing new research! We have found that the most rewarding part of teaching this class is the fun of getting to see the results of all the hard work at the end. 
