...
abstract: 
    "Replications are important to science, but who will do them? One proposal is that students can conduct direct replications as part of their training. As a proof-of-concept for this idea, here we report a series of 11 pre-registered, direct replications of findings from the 2015 volume of Psychological Science, all conducted as part of a graduate-level course. Congruent with previous studies, replications typically yielded smaller effects than originals: The modal outcome was partial support for the original claim. This work provides an estimate of the probability that a motivated graduate student can reproduce a previously published result on a first attempt, however, rather than a direct assessment of the truth of particular findings. We describe the workflow and pedagogical methods that were used in the class and discuss challenges both for the adoption of this pedagogical model and for replication research more broadly."
...
In the current article, we report the results of replication projects conducted in a single class (a graduate-level experimental methods course). As part of the required work of the course, students conducted high-power, direct replications of published articles from the 2015 volume of the journal *Psychological Science*. These studies both give evidence about the state of replicability in the field and provide insight into the challenges and promise of pedagogical replication. 

Past work has explicitly attempted to estimate the proportion of true effects in a particular literature [@ioannidis2005;@osc2015], but this goal is challenging -- perhaps even impossible [@gilbert2016;@anderson2016]. Presupposing that this construct is even meaningful [cf. @gergen1973], assessing the truth of even an individual effect relies on delineating what constitutes an exact replication [e.g., @stroebe2014] and establishing a standard for replication success [e.g., @simonsohn2015]. Estimating the proportion of true effects in a literature further requires a systematic sampling strategy to ensure generality. Furthermore, no single replication attempt is definitive, so multiple iterations are typically necessary to increase the evidential value of replication attempts [@lewis2016;@klein2014]. 

In the current work, we do not address these challenges; instead, our goal is more modest. We assess the probability that a graduate student can choose an article of interest and -- in a single attempt, within constraints of budget, expertise, and effort -- reproduce the findings. We consider a number of criteria for replication success, including statistical significance, effect size, a Bayesian measure of evidence [@etz2016], and a subjective assessment with respect to the original authors' interpretations. While each of these is imperfect, taken together these measures help provide a sense of how easy it is for a student to reproduce an effect to the degree that they could confidently build on it in future work. As we discuss below, these replications may have different interpretations: While some are more direct replications, others differ on theoretically-relevant dimensions. Indeed, due to differences in population, timing, or method, some of our findings might be construed as assessing the boundary conditions of a particular effect rather than replicating the original exactly. Even in these cases, however, our work contributes to an understanding of the robustness, generalizability, and expected effect sizes of previously published findings.

We also describe our process for conducting well-powered, high-quality, direct replications as part of classroom pedagogy. Although mentorship in specific experimental methods is an important part of the standard advising relationship, the classroom context allows for elucidation of general principles of good research and discussion of how they can be modified to fit specific instances. And replication research specifically illustrates a number of important concepts -- experimental design, power analysis, reporting standards, and preregistration, among others -- in a way that more open-ended projects, which require new conceptual development, often do not [see @frank2012 for a more extended argument]. There are significant limitations on what can be done in a single term, within the constraints of a course budget and the instructors' expertise, and we return to these in the Discussion. Nevertheless, were this approach implemented more widely, we believe the dividends paid to the field as a whole would be considerable. 
...
Atir, Rosenzweig, \& Dunning & 1b & No & Yes & Yes & 202 & Other &  50 & 6.67 & https://osf.io/uegk5/ \\ 
Ko, Sadler, \& Galinksy & 2 & Yes & Some & No &  40 & Original &  40 & 4.67 & https://osf.io/g6k2u/\\ 
Lewis \& Oyserman & 4 & No & Yes & Yes & 122 & 80\% power & 128 & 6.67 & https://osf.io/rdw6e/ \\ 
Liverence \& Scholl & 1 & No & Some & No &  18 & Original* &  19 & 5.33 & https://osf.io/sfxrb/ \\ 
Proudfoot, Kay, \& Koval & 1 & No & No & Yes &  80 & 80\% power &  84 & 6.67 & https://osf.io/ne8ph/ \\ 
Scopelliti, Loewenstein, \& Vosgerau & 3 & Yes & Yes & Yes & 550 & Other & 124 & 5.67 & https://osf.io/32wsm/ \\ 
Sofer et al. & 1 & No & Yes & No &  48 & Other &  95 & 4.33 & https://osf.io/5wmhn/ \\ 
Storm \& Stone & 3 & No & No & No &  48 & Original &  61 & 4.00 & https://osf.io/9cgpq/ \\ 
Wang et al. & 2 & No & No & No & 219 & 80\% power & 397 & 4.33 & https://osf.io/ng96w/ \\ 
Xu \& Franconeri & 1a & No & No & No &  12 & Other* &  27 & 5.00 & https://osf.io/cgvzs/ \\ 
Zaval, Markowitz, \& Weber & 1 & Yes & Yes & Yes & 312 & Original & 321 & 5.00 & https://osf.io/degwa/ \\ 
   \hline
\end{tabular}
...
In three cases, we powered the replication attempt to 80\% post-hoc power. In four
...
Each member of the instructor team coded the fidelity of replications, weighing whether the materials, sample, and task parameters differed from the original studies. We coded projects independently on a scale of 1 -- 7 (with 1 being a loose replication with substantive deviations from the original, and 7 being essentially identical), and then discussed our ratings and made adjustments (without coming to full consensus). The mean rating was `r round(mean(d$fidelity), digits = 2)` (Range = `r round(min(d$fidelity), digits = 2)` to `r round(max(d$fidelity), digits = 2)`). Several studies were essentially identical to the originals, but there was a group of others that included differences in population or number of trials that might plausibly have had an effect on the results. 
...
```{r, fig.height=9, fig.width=6, fig.cap="Side-by-side plots for each attempted replication. Error bars show standard error of the mean. Original data estimated from figures when not otherwise available. Replications are sorted by subjective replication success."}
