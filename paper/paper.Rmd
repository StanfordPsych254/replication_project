...
**Add our own paragraph and IRB notes**

We are not familiar with the particularities of Institutional Review Boards across institutions, but suspect certain ethical concerns will commonly arise when attempting to implement class replication projects.  We briefly highlight a few, with potential resolutions and comments.

*IRB approval is not possible within the time constraints of a class.*  To mitigate this issue, we suggest contacting the IRB chair well in advance of the class to determine how to either 1) create a standard protocol that encompassses all replications that will be conducted (in which details can be later added and quickly approved), or 2) plan to submit the protocol early in the course, in line with IRB meeting schedules for quick turnarounds. Both issues may be simplified if the study or pool of studies to be replicated is pre-determined and if said studies provide full open-source materials that can be used in the IRB protocol submitted.

*There is a potential for harm given constraints of class.* Instructor review. Has been previously approved, and coercion/privacy confidentiality. Anonymizing codes; securing data. How much role instructors play in this dependent on student competence.  
...
## Funding and Power limitations

(Eric -I think this should be addressed - maybe mention free participant pools, value of learning how to recruit. OR if lucky (like us) apply for a grant.  Also call for OSF and other organizations devoted to replications to provide small grants of this sort.
