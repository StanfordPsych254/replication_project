...
In addition to as-needed guidance on projects, students advanced through a formal review process in which each student's work was inspected and critiqued several times by both the instructor and the teaching assistants. After selecting their replication targets, students' first milestone was to fill in the methods section of the @osc2015 replication report template, which was reviewed for feasibility and concreteness. This section included a power analysis, proposed sample size, and explicit description of differences from the original study (see course materials for complete template).  
...
Subject population & \multicolumn{1}{p{2in}}{\raggedright University or classroom participant pool} & \multicolumn{1}{p{2in}}{\raggedright In-person or online convenience sample} & \multicolumn{1}{p{2in}}{\raggedright Targeted sampling of original populations} \\
...
Dissemination & \multicolumn{1}{p{2in}}{\raggedright If meeting pre-specified quality standard} & \multicolumn{1}{p{2in}}{\raggedright With instructor approval} & \multicolumn{1}{p{2in}}{\raggedright As class default (subject to discussion)} \\
