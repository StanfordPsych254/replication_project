...
temp_project_keys <- c("mkeil","smraposo","jreynolds","jmarias","ehermann") # Only do users we have data for currently
...
for(project_key in temp_project_keys) { # change from temp - test; project_key <- "smraposo"
  ...
  source(fp)
  #tryCatch(source(fp), error=function(e) {errors <- c(errors,paste0(project_key," has an error in .R file"),print(fp))}) 
